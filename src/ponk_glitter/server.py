...
@cache
def glitter_conllu_text(conllu_string: str, model_name: str) -> str:
    model = MODELS[model_name]
    conllu_data = conllu.parse(conllu_string)
    text_to_glitter = ""
...
def process_conllu():
    ...
    modified_conllu_string = glitter_conllu_text(conllu_string, "GPT-2 XL Czech")
    result = {
